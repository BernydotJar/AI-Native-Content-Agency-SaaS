...
- [x] Define exact binding, states and non-goals.
- [x] Add gateway preflight descriptor.
- [x] Implement SQLite intent store.
- [x] Implement PostgreSQL schema v4 and store.
- [x] Implement fenced authority and failure semantics.
- [x] Add explicit governed-run API integration.
