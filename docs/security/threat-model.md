...
| T-016 | Elevation of privilege | Compromise overprivileged PostgreSQL runtime account. | Connection settings validated and queries parameterized. | Runtime currently initializes schema and a non-owner least-privilege production role is not demonstrated; migrations and runtime authority are not separated. | HIGH open |
