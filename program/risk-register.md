...
| R-015 | HIGH | PostgreSQL runtime role could initialize/own schema rather than operating with exact non-owner grants. | Effective local `23bfee60f8536d2fcd7e3c5ca20636103f9401c8` implements initialize/validate separation, fixed search path, atomic initialization, exact non-owner grants and negative DDL/TEMP/escalation/rollback fixtures; no behavioral gate, push/CI or persistent environment observation has run. | Open, remediation in progress |
