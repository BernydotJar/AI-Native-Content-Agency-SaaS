...
| R-015 | HIGH | PostgreSQL runtime role could initialize/own schema rather than operating with exact non-owner grants. | Exact local `612e03c1a90f644a8cd26fde785f3980491bab9d` passes 85/85 under the non-owner role plus grants, denial, migration, restore, package and infrastructure gates; remote CI and persistent environment observation remain pending. | Local remediation verified; delivery/environment evidence pending |
