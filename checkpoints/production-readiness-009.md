...
- provenance: in-toto statement bound to clean source commit `5dfe65ca6b7cebb3536d31f23da24328ee8f9416`, immutable inputs and artifact hashes;
...
- application package smoke: full Alpine health/readiness/SPA/session/CSRF/request-correlation/run/Scholar/Greenlight/package/audit/metrics/revocation matrix passed;
- frontend: Oxlint passed, 33/33 tests passed and Vite production build passed;
- backend: hash-locked wheel, `pip check` and 33/33 tests passed;
- Python lockfiles: regenerated byte-identically;
- workflow: actionlint passed;
- generated evidence checksums: 5/5 files verified from `SHA256SUMS`.
