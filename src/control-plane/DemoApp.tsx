          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-full border border-amber-300/20 bg-amber-300/[0.08] px-2 py-0.5 font-mono text-[9px] text-amber-200">LEGACY DEMO MODE</span>
              </div>
              <p className="mt-0.5 truncate text-[11px] text-zinc-500">Browser-only timer simulation · isolated from persisted API runs</p>
            </div>
          </div>

          <div className="flex flex-wrap items-center gap-2 text-[11px]">
            <span className="status-pill">
              <Layers size={12} aria-hidden="true" /> 8-station demo
            </span>
